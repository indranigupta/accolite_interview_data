...
public class ExcelReader {
    ...
    public static List<DataModelObject> readExcel(String filePath) throws IOException {
        List<DataModelObject> data = new ArrayList<>();
        ...
        try (FileInputStream fis = new FileInputStream(filePath);
            ...
            while (rowIterator.hasNext()) {
                ...
                DataModelObject dataModel = new DataModelObject();
                ...
                dataModel.setCandidatePreferredLocation(getCellValue(row.getCell(8)));
