package model;// ChartGenerator.java
...
public class ChartGenerator {
    public static JFreeChart createChart(List<DataModelObject> data) {
    ...
    private static CategoryDataset createDataset(List<DataModelObject> data) {
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();

        // Example: Count interviews by team
        Map<String, Long> teamInterviewCounts = data.stream()
                .collect(Collectors.groupingBy(DataModelObject::getTeam, Collectors.counting()));
